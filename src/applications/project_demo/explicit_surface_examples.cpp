...
GraphicsLab::Geometry::ExplicitSurface ExplicitSurfaceExample::createDeformedTorus2(glm::vec3 offset, glm::vec2 param_offset) {
    auto f = [offset, param_offset](GraphicsLab::Geometry::autodiff_vec2 param) -> GraphicsLab::Geometry::autodiff_vec3 {
        GraphicsLab::Geometry::autodiff_vec3 result;
