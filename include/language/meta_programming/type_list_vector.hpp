...
template <typename... ts> struct TypeListVector {
  ...
  private:
    ...
    template<typename target_type, size_t current_index>
    Generator<target_type> traverse_as_detail() {
