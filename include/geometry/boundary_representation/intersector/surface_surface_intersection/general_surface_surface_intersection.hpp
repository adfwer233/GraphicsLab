  ...
  private:
    ...
    static std::vector<SSIResult> intersect_all(const ParamSurface *surf1, const ParamSurface *surf2) {
        ...
        for (auto &trace : trace_results) {
            ...
            curve.control_points_.back() = points.back();
            ...
            //
            // spdlog::info("pcurve1 ctrl pts");
            // for (auto ctrl: pcurve1.control_points_) {
            //     spdlog::info("pcurve1 ctrl pt {} {}", ctrl.x, ctrl.y);
            // }
            // spdlog::info("pcurve1 ctrl pts end");
