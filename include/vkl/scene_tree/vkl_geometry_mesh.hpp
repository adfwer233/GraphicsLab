...
namespace SceneTree {
    ...
    template<>
    class VklGeometryMesh<TensorProductBezierSurface> {
    public:
    ...
    template<VklVertexType VertexType, VklIndexType IndexType>
    class VklGeometryMesh<MeshGeometry<VertexType, IndexType>> {
        ...
        VklGeometryMesh(VklDevice &device, MeshGeometry<VertexType, IndexType> mesh_geometry): device_(device), mesh_geometry_(mesh_geometry) {
            createMesh();
        }
        ...
        void createMesh() {
            ...
            builder.vertices = mesh_geometry_->vertices;
